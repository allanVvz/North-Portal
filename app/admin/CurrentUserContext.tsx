...
export type CurrentAdminUser = { name: string; email: string; initials: string; userId: string };

const FALLBACK: CurrentAdminUser = { name: "Administrador", email: "", initials: "AD", userId: "" };
