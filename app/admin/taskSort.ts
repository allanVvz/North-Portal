...
export const SORT_KEYS = ["manual", "alfabetico", "edicao", "data"] as const;
 ...
 *
 * 1. **Sem prazo vai sempre para o fim**, nas duas direções. Inverter a
...
export function sortItems<T>(
  ...
  decorated.sort((a, b) => {
    if (key === "data") {
      const aMissing = !a.fields.dueDate;
      const bMissing = !b.fields.dueDate;
