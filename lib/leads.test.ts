...
describe("leads", () => {
  ...
  it("createWhatsAppUrl lança com número curto — a rota degrada pra whatsapp_url:null", () => {
    const input = { name:"Ana",company:"Aurora",segment:"Serviços",region:"Santos",objective:"Crescer" };
    expect(() => createWhatsAppUrl("5511", "abc", input)).toThrow(/WHATSAPP_BUSINESS_NUMBER/);
  });
});
