-- Pause daily automations using deliveryTypeId per piece before applying this rollback.
-- Historical format types and workflow versions remain to preserve existing cards.
BEGIN;
...
DROP FUNCTION IF EXISTS public.publish_delivery_workflow(uuid, jsonb);
COMMIT;
